# MFIL DAO Community Code of Conduct
...
- Violations of this code may result in swift and permanent expulsion from the MFIL DAO community.
- "Too long, didn't read" is not a valid excuse for not knowing what is in this document.

## Scope

We expect all members of the MFIL DAO community to abide by this Code of Conduct
at all times in all MFIL DAO community venues, online and in person, and in one-on-one
communications pertaining to MFIL affairs.

This policy covers the usage of MFIL public infrastructure, as well as other MFIL websites, MFIL related events,
and any other services offered by or on behalf of the MFIL DAO community. It also
applies to behavior in the context of the MFIL Open Source project
...
invalidate, any other terms or conditions related to use of MFIL services.
...
Media shared through public infrastructure run by the MFIL DAO team must not
contain illegal or infringing content. You should only publish content via
MFIL public infrastructure if you have the right to do so. This includes
...
Conduct, please contact us at [@MFILDAO](https://github/MFILDAO) to send us an abuse report. If
...
If a community member engages in unacceptable behavior, the MFIL DAO team
